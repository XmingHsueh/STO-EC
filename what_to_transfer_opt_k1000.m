...
folder_problems = '.\benchmarks-k1000'; % the folder that stores the test problems
...
for n = 1:num_problems
    ...
    for r = 1:runs
        ...
        for m = 1:length(algorithm_list)
            ...
            [solutions,objs] = tea_search(problem,popsize,FEsMax,...
    ...
    save(['.\experimental studies\results-what-opt-k1000\',task_families{specifications(n,1)},'-T',...
        ...
        '-k',num2str(specifications(n,6)),'-what.mat'],'results_opt');
end
close(h);