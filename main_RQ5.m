...
% Description:
% ------------
% This file is the entry point of experimentally comparing three S-ESTO
% algorithms that integrate solution selection and solution adaptation.
%
% ------------
% Reference:
% ------------
...
algorithm_list = [6 7;4 3;6 4]; % integration-driven S-ESTOs
            ...
            for s = 1:length(source_generations)
                for xi = xis
                    for d = ds
                        ...
                        % save the results
                        save(['.\experimental studies\results-rq5\',problem_families{p},'-',transfer_scenarios{t},'-',source_generations{s},'-x',num2str(xi),...
