...
% baseline solvers and nine adaptation-based S-ESTOs. The corresponding
...
title(['$d=',num2str(d),', \mathcal{G}=',generation_scheme,'$'],'interpret','latex','fontsize',14);
fig_width = 350;
fig_height = 300;
screen_size = get(0,'ScreenSize');
figure1 = figure('color',[1 1 1],'position',[(screen_size(3)-fig_width)/2, (screen_size(4)-...
...
xlabel('Algorithms','interpret','latex','fontsize',12)
ylabel('Performance Ranks','interpret','latex','fontsize',12);
title(['$d=',num2str(d),', \mathcal{G}=',generation_scheme,', \xi=1$'],...
