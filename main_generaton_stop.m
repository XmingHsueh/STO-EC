...
% Description:
% ------------
% This file is the script of generating sequential transfer optimization
% problems using the problem generator developed in the following paper.
%
% ------------
% Reference:
% ------------
% X. Xue, C. Yang, L. Feng, et al. "A Scalable Test Problem Generator for Sequential 
% Transfer Optimization", arXiv preprint, 2023.
