...
% and the selection-based S-ESTOs.
%
% ------------
% Reference:
% ------------
...
metrics = {'N','R','C','M1','KLD','WD','OC','ROC','SA'}; % similarity metrics

idx_problem = 1; % the problem from which the results to be visualized are collected
fig_width = 350;
fig_height = 300;
...
num_points_plot = 15;
std_level = 0.5;
c_list = [0 0 0;255 0 0;0 255 0;0 0 255;255 255 0;0 255 255;255 0 255;125 0 255;255 125 0;0 125 255]/255;
m_list = ['o','+','*','x','s','d','^','v','p','>'];
...
title(['FS: STOP ',num2str(idx_problem),],'interpret','latex','fontsize',14);